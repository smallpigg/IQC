...
for i in range(0, len(df)):
    ...
    str1 = df.loc[i, 'IQC文件编号'][0:3] + df.loc[i, 'IQC文件编号'][8:11] + '_1_' + df.loc[i, 'IQC文件编号'] + '-' + df.loc[i, 'IQC版本'] + '版 ' + df.loc[i, 'IQC物料名称'] + ' ' + '进货检验作业指导书.docx'
...
for i in range(0, len(df)):
    str1 = df.loc[i, 'IQC文件编号'][0:3] + df.loc[i, 'IQC文件编号'][8:11] + '_4_' + 'TB-' + df.loc[i, 'IQC文件编号'] + '-' + df.loc[i, 'IQC_TB版本'] + '版 ' + df.loc[
